  ...
  return (
    <div className="relative">
      <button
        ...
        className="px-14 py-2 border border-black -mb-px text-sm font-['Space_Mono'] leading-6 transition-all duration-150 active:translate-y-[1px] bg-white text-black hover:bg-gray-50"
      >
        Create
      </button>
